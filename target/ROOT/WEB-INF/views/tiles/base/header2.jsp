...
<c:set var="contextPath" value="${pageContext.request.contextPath}"></c:set>
	 <header id="header" class="main-header page-topbar" style="    max-height: 67px;">
	 <a href class="logo">
    ...
    <nav class="navbar navbar-static-top" style="    top: -50px;">
	...
	<div id="successDiv"
      ...
      <div class="navbar-fixed navbar-custom-menu" ng-controller="languageController" >
        <ul class="nav navbar-nav">
          <!-- <li class="dropdown">
