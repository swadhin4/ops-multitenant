...
<script type="text/javascript" 	src='<c:url value="/resources/theme1/js/sp-extcustomer-incident-create-controller.js?n=${System.currentTimeMillis()  + UUID.randomUUID().toString()}"></c:url>'></script>
...
<div class="content-wrapper">
		<div  ng-controller="spExtCustomerIncidentCreateController" id="spIncidentCreateWindow">
						...
						<div class="row" >
		                   ...
		                   <div class="col-md-6" >
							...
							<div class="col-md-6 reqDiv required">							  	
							 <label class="control-label" for="title">External Customer</label>
							 <select name="extCustSelect" id="extCustSelect" class="form-control  pull-left" 
							style="margin-right: 5px;" 
							ng-model="extCustomer.selected"  required
							onchange="angular.element(this).scope().getCustomerSelected(this, event, 'extCustSelect')" required>
							</select>
							 </div>
